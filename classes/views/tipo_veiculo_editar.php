    ...
    <div class="row justify-content-center align-items-center">
        <div class="col-6">
            ...
            <div class="card-header">
                <h4 class="card-title">Cadastro de Tipo Veiculo</h4>
            </div>
            <!-- /.card-header -->

            <!-- form start -->
            <form name="form1" role="form" method="POST" action="../controllers/tipo_veiculo_controller.php">
                <input type="hidden" name="txtId" value="<?php echo $tipo_veiculo->id ?>">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Descrição</label>
                                <input type="text" class="form-control form-control-sm" name="txtDescricao" value="<?php echo $tipo_veiculo->descricao ?>">
                            </div>
                        </div>               
                    </div>
                </div>
